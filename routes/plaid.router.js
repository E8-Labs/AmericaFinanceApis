...
import {CreateLinkToken, GetLiabilities, GetIdentity, ExchangePublicToken, GetPayrolIncome, 
    GetUserBalance, CreateTransferAuthorizeRequest, CreateTransfer, GetBankIncome, GetEmploymentDetails,
...
plaidRouter.post("/bank_income", verifyJwtToken, GetBankIncome);
plaidRouter.post("/employment_details", verifyJwtToken, GetEmploymentDetails);
